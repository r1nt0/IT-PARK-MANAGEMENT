	...
	<div class="top-nav">
		<div class="container-fluid">
			<nav class="navbar navbar-expand-lg navbar-light">
				<a class="navbar-brand text-uppercase" href="index.html">Kochi Cyber  <i class="fas fa-building"></i><span>Village</span></a>
				...
				<div class="collapse navbar-collapse justify-content-center pr-md-4" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="dropdown nav-item">
							<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">Company
								<b class="caret"></b>
							</a>
							<ul class="dropdown-menu agile_short_dropdown">
								<li>
									<a href="Admin View Company.php">Request</a>
								</li>
								<li>
									<a href="Admin View Existing.php">View Existing</a>
								</li>
							</ul>
						</li>
						<li class="nav-item">
...
<section class="agile-footer w3ls-section py-5">
	<div class="container">
		...
		<div class="agileits_w3layouts-copyright text-center">
			<p>© 2023 Kochi Cyber Village. All Rights Reserved | Design by Rinto Jacob
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        Companies can buy or rent our land.Use our facilities by agreeing to our terms and conditons.The students can join and search for job opportunities in various companies for free.
      </div>
